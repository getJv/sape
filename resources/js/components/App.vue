<template>
  <v-app id="inspire">
    ...
    <v-app-bar v-if="isAuthenticated" :elevation="1" app clipped-left color="blue-grey lighten-5">
      <v-app-bar-nav-icon color="blue-grey darken-5" @click.stop="drawer = !drawer" />
      <v-toolbar-title>SAPE</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-img class="text--center" :src="imageHeader" max-width="250"></v-img>
    </v-app-bar>
