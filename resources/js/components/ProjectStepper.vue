  ...
  <v-card>
    ...
    <v-card-text>
      <v-stepper v-model="e13" vertical>
        <span v-for="phase in [1, 2, 3]" :key="phase">
          <v-stepper-step :step="phase" @click="e13 = phase" :complete="e13 < 1">
            <span>
              Prospecções de Serviços
              <BtnAddEvent :hasSession="true" :step_id="phase" />
            </span>
          </v-stepper-step>
